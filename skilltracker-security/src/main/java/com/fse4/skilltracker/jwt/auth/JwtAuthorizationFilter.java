package com.fse4.skilltracker.jwt.auth;
...
import com.fse4.skilltracker.jwt.services.UserInfoService;
import com.fse4.skilltracker.jwt.services.JwtService; 
...
public class JwtAuthorizationFilter extends OncePerRequestFilter { 
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException { 
		...
		if (authHeader != null && authHeader.startsWith(AUTHORIZATION_HEADER_BEARER_PREFIX)) { 
			//token = authHeader.substring(AUTHORIZATION_HEADER_BEARER_PREFIX_LENGTH);
